...
$sql = "SELECT * FROM article WHERE article_sort='culture'";
...
if ($page) {
    ...
    $sql = "SELECT * FROM article WHERE article_sort='culture' 
     ORDER BY article_id  limit $offset,$page_size";
    $result = mysqli_query($conn, $sql);
}
?>
<!doctype html>
            ...
            <div class="col-sm-12 col-md-8 culture_right">
                ...
                <div class="page">
                    <ul class="pagination justify-content-start">
                        <li class="page-item ">
                            <a class="page-link"
                               href="culture.php?page=1">首页</a>
                        </li>
                        <li class="page-item">
                            <a class="page-link"
                               href="culture.php?page=<?php echo($page - 1) ?>">
                                上一页</a></li>
                        <li class="page-item">
                            <a class="page-link"
                               href="culture.php?page=<?php echo($page + 1) ?>">
                        ...
                        <li class="page-item">
                            <a class="page-link"
                               href="culture.php?page=<?php echo $page_count ?>">
                                尾页</a></li>
